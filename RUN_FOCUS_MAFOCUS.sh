...
--out /gpfs/data/huo-lab/BCAC/james.li/XANCESTRY_GWAS_TWAS/output/TWAS/FOCUS/output/focus_${subtype}_${race}_${celltype}
done
done
done
...
--out /gpfs/data/huo-lab/BCAC/james.li/XANCESTRY_GWAS_TWAS/output/TWAS/FOCUS/output/mafocus_${subtype}_${celltype}
done
done
