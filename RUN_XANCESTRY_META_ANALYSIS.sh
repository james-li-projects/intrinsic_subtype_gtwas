# Define directories
DATA_DIR="/gpfs/data/huo-lab/BCAC/james.li/XANCESTRY_GWAS_TWAS/output/GWAS/XANCESTRY_META/input"
OUTPUT_DIR="/gpfs/data/huo-lab/BCAC/james.li/XANCESTRY_GWAS_TWAS/output/GWAS/XANCESTRY_META/output"
...
for SUBTYPE in "${SUBTYPES[@]}"; do
    ...
    OUTPUT_PREFIX="${OUTPUT_DIR}/XANCESTRY_METAANALYSIS_${SUBTYPE}"
